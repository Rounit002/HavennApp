      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Create/Edit form */}
            <div className="bg-white/95 dark:bg-gray-800/95 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 ring-1 ring-[#E1F5EE]/70 dark:ring-[#0F6E56]/40 mb-6">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <input
                  ...
                  className="w-full sm:w-auto flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white/95 dark:bg-gray-700/80 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#9FE1CB] shadow-sm"
                />
                <button onClick={handleSubmit} className="px-4 py-2 bg-gradient-to-r from-[#1D9E75] via-fuchsia-500 to-sky-500 text-white rounded-md shadow-md hover:from-[#E1F5EE] hover:via-fuchsia-400 hover:to-sky-400 focus:ring-2 focus:ring-[#9FE1CB] ring-1 ring-white/20">
            ...
            <div className="bg-white/95 dark:bg-gray-800/95 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-x-auto">
              <table className="w-full min-w-[480px]">
                <thead>
                  <tr className="bg-gradient-to-r from-[#E1F5EE] via-fuchsia-50 to-sky-50 dark:from-gray-700 dark:via-gray-700 dark:to-gray-700">
                    ...
                    <tr key={product.id} className="border-t border-gray-200 dark:border-gray-700">
                      ...
                      <td className="px-4 sm:px-6 py-3">
                        <div className="flex gap-3">
                          <button onClick={() => handleEdit(product)} className="px-2 py-1 text-xs rounded-md bg-[#E1F5EE] text-[#0F6E56] border border-[#9FE1CB] hover:bg-[#E1F5EE] dark:bg-[#0F6E56]/30 dark:text-[#9FE1CB] dark:border-[#0F6E56]">Edit</button>
